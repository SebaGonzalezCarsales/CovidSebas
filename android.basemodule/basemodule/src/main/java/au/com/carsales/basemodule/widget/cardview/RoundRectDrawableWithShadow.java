...
class RoundRectDrawableWithShadow extends Drawable {
    ...
    * */
    ...
    RoundRectDrawableWithShadow(Resources resources, ColorStateList backgroundColor, float radius,
        ...
        mShadowStartColor = resources.getColor(androidx.cardview.R.color.cardview_shadow_start_color);
        mShadowEndColor = resources.getColor(androidx.cardview.R.color.cardview_shadow_end_color);
        mInsetShadow = resources.getDimensionPixelSize(androidx.cardview.R.dimen.cardview_compat_inset_shadow);
