...
import au.com.carsales.basemodule.util.crashlytics.CrashlyticsConstants
import au.com.carsales.basemodule.util.crashlytics.CrashlyticsConstants.Companion.CRASHLYTICS_TAG_NAME
...
abstract class BaseModuleFragment : Fragment(), GlobalError, GlobalErrorClickHandler,
    FragmentLifeCycle {
    ...
    @Deprecated(
        message = "Use data binding for this state",
    ...
    @Deprecated(
        message = "Use new showGlobalErrorView() instead",
        level = DeprecationLevel.WARNING,
        replaceWith = ReplaceWith(
    ...
    var savedStateView: Bundle? = null
    ...
    override fun onCreateView(
        ...
        try {
            ...
            /*
            Crashlytics.log(
                Log.ERROR, "onCreateView", "BaseModuleFragment: "
  ...
  //      Crashlytics.setString(CrashlyticsConstants.CRASHLYTICS_TAG_NAME, tagName())
    }
...
//            )
    ...
    fun showGlobalErrorView(
        ...
        errorViewComponent.setErrorClickHandler(errorClickHandler = object :
            GlobalErrorClickHandler {
    ...
    protected fun showIndicator(
        ...
        try {
           ...
           /* Crashlytics.log(
                Log.ERROR,
                BaseModuleFragment::class.simpleName,
    ...
    fun savedStateView(bundle: Bundle) {
        this.savedStateView = bundle
    }
...
/**
 * Used to optionally implement
 * new global error messaging from API
 */
