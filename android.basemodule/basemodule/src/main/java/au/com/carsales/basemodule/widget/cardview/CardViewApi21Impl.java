...
class CardViewApi21Impl implements CardViewImpl {
    ...
    public void initialize(CardViewDelegate cardView, Context context,
                ColorStateList backgroundColor, float radius, float elevation, float maxElevation, int cornerFlag) {
        final CSRoundRectDrawable
            background = new CSRoundRectDrawable(backgroundColor, radius, cornerFlag);
